...
- Name: uc-07-11-todos.spec.ts >> UC-09. 할일 수정 >> 기본 흐름: 할일 내용 수정 후 목록에 즉시 반영
- Location: test\e2e\uc-07-11-todos.spec.ts:100:7
...
Call log:
  - waiting for getByLabel('원본_1778806404526 수정')
    - locator resolved to <button aria-label="원본_1778806404526 수정">수정</button>
    ...
    - generic [ref=e13]:
      ...
      - main [ref=e26]:
        ...
        - generic [ref=e36]:
          ...
          - generic [ref=e39]:
            - generic [ref=e40]: 원본_1778806404526
            - generic:
              - button "원본_1778806404526 수정": 수정
              - button "원본_1778806404526 삭제": 삭제
  - generic [ref=e41]:
    - img [ref=e43]
