...
- Name: uc-07-11-todos.spec.ts >> UC-11. 할일 삭제 >> 기본 흐름: 삭제 확인 후 목록에서 즉시 제거
- Location: test\e2e\uc-07-11-todos.spec.ts:155:7
...
Call log:
  - waiting for getByLabel('삭제테스트_1778806467738 삭제')
    - locator resolved to <button aria-label="삭제테스트_1778806467738 삭제">삭제</button>
    ...
    - generic [ref=e13]:
      ...
      - main [ref=e26]:
        ...
        - generic [ref=e36]:
          ...
          - generic [ref=e39]:
            - generic [ref=e40]: 삭제테스트_1778806467738
            - generic:
              - button "삭제테스트_1778806467738 수정": 수정
              - button "삭제테스트_1778806467738 삭제": 삭제
  - generic [ref=e41]:
    - img [ref=e43]
