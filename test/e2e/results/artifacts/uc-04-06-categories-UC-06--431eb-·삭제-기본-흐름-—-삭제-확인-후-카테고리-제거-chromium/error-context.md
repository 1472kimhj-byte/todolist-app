...
- Name: uc-04-06-categories.spec.ts >> UC-06. 사용자 정의 카테고리 수정·삭제 >> 기본 흐름 — 삭제: 확인 후 카테고리 제거
- Location: test\e2e\uc-04-06-categories.spec.ts:72:7
...
Locator: getByText('삭제대상_1778806374952')
Expected: visible
Error: strict mode violation: getByText('삭제대상_1778806374952') resolved to 2 elements:
    1) <span>삭제대상_1778806374952</span> aka getByRole('button', { name: '삭제대상_1778806374952 선택' })
    2) <option value="eba22e2f-fe5a-4c82-856d-7f60b4073744">삭제대상_1778806374952</option> aka getByLabel('카테고리 필터')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('삭제대상_1778806374952')
      ...
      - complementary [ref=e14]:
        - generic [ref=e15]:
          ...
          - button "쇼핑 선택" [ref=e24] [cursor=pointer]:
            - generic [ref=e25]: 쇼핑
          - button "삭제대상_1778806374952 선택" [ref=e26] [cursor=pointer]:
            - generic [ref=e27]: 삭제대상_1778806374952
            - generic [ref=e28]:
              - button "삭제대상_1778806374952 수정" [ref=e29]: 수정
              - button "삭제대상_1778806374952 삭제" [ref=e30]: 삭제
      - main [ref=e31]:
        - generic [ref=e32]:
