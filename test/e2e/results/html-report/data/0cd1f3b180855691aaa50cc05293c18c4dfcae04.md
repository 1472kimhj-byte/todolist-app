...
- Name: uc-07-11-todos.spec.ts >> UC-11. 할일 삭제 >> E1. 삭제 취소: 목록 변경 없음
- Location: test\e2e\uc-07-11-todos.spec.ts:168:7
...
Call log:
  - waiting for getByLabel('취소테스트_1778806498452 삭제')
    - locator resolved to <button aria-label="취소테스트_1778806498452 삭제">삭제</button>
    ...
    - generic [ref=e13]:
      ...
      - main [ref=e26]:
        ...
        - generic [ref=e36]:
          ...
          - generic [ref=e39]:
            - generic [ref=e40]: 취소테스트_1778806498452
            - generic:
              - button "취소테스트_1778806498452 수정": 수정
              - button "취소테스트_1778806498452 삭제": 삭제
  - generic [ref=e41]:
    - img [ref=e43]
